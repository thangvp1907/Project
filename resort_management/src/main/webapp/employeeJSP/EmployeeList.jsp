        ...
        <div class="col-8">
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    ...
                    <c:if test="${index != 1}">
                        <li class="page-item"><a class="page-link" href="/EmployeeServlet?action=paging&index=${index - 1}">Previous</a></li>
                    </c:if>
                    <c:forEach begin="1" end="${maxPages}" var="item">
                        <li class="page-item"><a class="page-link" href="/EmployeeServlet?action=paging&index=${item}">${item}</a></li>
                    </c:forEach>
                    <c:if test="${index == maxPages}">
                        <li class="page-item"><a class="page-link" href="#" style="color: darkgray">Next</a></li>
                    </c:if>
                    <c:if test="${index != maxPages}">
                        <li class="page-item"><a class="page-link" href="/EmployeeServlet?action=paging&index=${index + 1}">Next</a></li>
                    </c:if>
                </ul>
            </nav>
        </div>
